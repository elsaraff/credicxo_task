...
TrackIdModel trackIdModelFromJson(String str) =>
    TrackIdModel.fromJson(json.decode(str));

String trackIdModelToJson(TrackIdModel data) => json.encode(data.toJson());
...
class TrackIdModel {
  ...
  factory TrackIdModel.fromJson(Map<String, dynamic> json) => TrackIdModel(
